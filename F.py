...
class F(object):
  ...
  def __call__(self,icg_input,c620_feed,t651_feed):
    ...
    c620_wt = self.c620_wt_post_processing(c620_input['Tatoray Stripper C620 Operation_Specifications_Spec 3 : Benzene in Sidedraw_wt%'],c620_wt) # 後處理
    ...
    c660_wt = self.c660_wt_post_processing(c660_input['Benzene Column C660 Operation_Specifications_Spec 2 : NA in Benzene_ppmw'],c660_wt) #後處理
